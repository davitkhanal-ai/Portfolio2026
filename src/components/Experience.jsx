...
const experiences = [
  {
    ...
    description:
      "Leading the database migration team for a high-traffic fintech platform.",
    task: [
      "Assisted in managing and maintaining SQL Server used by over 700K users and handling 150K+ daily transactions.",
      "Perform regular index maintenance, statistics updates, and query performance tuning",
      "Monitor and optimize database performance",
      "Create and manage T-SQL scripts, stored procedures, functions, and triggers",
    ],
  },
  {
    year: "2024 - 2025",
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className="md:w-1/2 pl-8 md:pl-0 md:px-12">
                  ...
                  >
                    <span className="text-cyan font-mono text-sm mb-2 tracking-wider">
                      {exp.year}
                    </span>
                    <h3 className="text-2xl font-bold text-white mb-1">
                      {exp.company}
                    </h3>
                    <h4 className="text-lg text-white-500 mb-4">{exp.role}</h4>
                    <p
                      className={`text-white-400 mb-4 text-sm leading-relaxed ${
                    ...
                    >
                      {exp.task.map((item, i) => (
                        <li
                          key={i}
                          className="text-gray-400 text-sm flex items-start gap-2 justify-start md:justify-inherit"
                        >
